...
namespace MovieBooking.BLL.POCOModel
{
    ...
    public partial class RegisteredUser : mb_RegisteredUser, IRegisteredUser, IDisposable
    {
        ...
        [StringLengthValidator(19, RangeBoundaryType.Inclusive, 19, RangeBoundaryType.Inclusive, MessageTemplate = "NRIC must be 9 characters long!")]
        ...
        [NotNullValidator(MessageTemplate = "DOB - Cannot be null!")]
