...
{
    public partial class mb_MovieBooking_Trans
    {
        ...
        {
            if (previousValue != null && previousValue.mb_MovieBooking_Trans.Contains(this))
            {
                previousValue.mb_MovieBooking_Trans.Remove(this);
            }
    
            if (mb_MovieBooking != null)
            {
                if (!mb_MovieBooking.mb_MovieBooking_Trans.Contains(this))
                {
                    mb_MovieBooking.mb_MovieBooking_Trans.Add(this);
                }
