<%@ Page Title="" Language="C#" Theme="Theme1" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MovieMaintainence.aspx.cs" Inherits="MovieBooking.UI.Maintenance.Movie.MovieMaintainence" %>
...
<div class="accountInfo">
    <fieldset class="register">
        <legend>Movie Maintenance -> Add</legend>
...
<span class="failureNotification">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TxtMovName" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
</span>
            </td>
            <td>
                &nbsp;</td>
...
<span class="failureNotification">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                    ControlToValidate="txtCast1" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
</span>
            </td>
            <td>
                &nbsp;</td>
...
<span class="failureNotification">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                    ControlToValidate="txtCast2" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
</span>
            </td>
            <td>
                &nbsp;</td>
...
<span class="failureNotification">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                    ControlToValidate="txtCast3" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
</span>
            </td>
            <td>
                &nbsp;</td>
