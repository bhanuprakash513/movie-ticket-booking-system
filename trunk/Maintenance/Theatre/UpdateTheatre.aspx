...
<div class="accountInfo">
    <fieldset class="register">
       ...
       <%-- <asp:RequiredFieldValidator ID="TheatreNameRequired" runat="server" ControlToValidate="" 
        ...
        <asp:TextBox ID="TheatreEmail" runat="server" CssClass="textEntry" MaxLength="50" Width="396px"></asp:TextBox>
        ...
        <asp:TextBox ID="TheatreWebSiteAddress" runat="server" CssClass="textEntry" MaxLength="50" 
